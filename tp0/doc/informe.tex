...
La segunda parte de un número complejo es un número \textit{imaginario}.
...
El formato PGM es una formato para almacenar informacion grafica en un texto
plano.

Se detalla abajo un ejemplo de un puntito blanco.
...
255 # Matriz de puntos

\end{lstlisting}

\subsection{Linea de comandos}

El programa tiene que ser capaz de leer argumentos pasados por linea de
comandos.
...
Desarrollamos un wrapper en Python\cite{PYTHON} para tomar los parametros de un query string http, y mapearlos a un comando de linea de comandos.
...
Se detalla abajo la parte relevante del codigo.
...
Utilizamos el framework de javascript jQuery \cite{JQUERY} para manejar el
click del usuario sobre la imagen.
...
<html>
    <head>
        ...
        <script type="text/javascript" src="mandelmap.js"></script>
    </head>
    <body>
        <img id="mandelmap">
    </body>
